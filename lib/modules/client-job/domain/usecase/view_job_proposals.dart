...
class ProposalUseCase implements UseCase<JobProposalEntity, JobParams> {
  final JobRepository repository;

  ProposalUseCase({required this.repository});

  @override
  Future<Either<Failure, JobProposalEntity>> call(JobParams params) async {
    ...
    Either<Failure, JobProposalEntity> job =
        await repository.viewProposals(params);
